...
class ResultZipper(Schedulable):
    ...
    def __init__(self, user_id: int, task_id: int, error_occurred: bool,
        ...
        :param error_occurred: Whether at least one ExecutionElement failed
        during the Execution
        :param task_progress_callback: The Execution calls this callback
    ...
    def do_work(self) -> None:
        ...
        This is to ensure that a corrupted file can be spotted,
        ...
        TaskHelper.zip_dir(zip_path_running=self._zip_path_running,
                           zip_path_final=self._zip_path_final,
                           dir_path=self._dir_path)
        TaskHelper.del_dir(self._dir_path)

        if self._error_occurred:
            self._task_progress_callback(self._task_id,
