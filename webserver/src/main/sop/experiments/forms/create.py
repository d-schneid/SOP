...
class ExperimentCreateForm(forms.ModelForm[Experiment]):
    ...
    The dataset field of the form is currently not displayed in the html template though, instead the html is created
    manually, to enable uncleaned datasets to appear greyed-out. As a consequence, the dataset field of this Form
    is populated with the info from the raw html dataset selection and then the form is used to create the model.
    """
